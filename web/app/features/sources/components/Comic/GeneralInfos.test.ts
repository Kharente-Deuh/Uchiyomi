...
function comic(overrides: Partial<SourceComicInfos> = {}): SourceComicInfos {
  return {
    slug: 'solo-leveling',
    title: 'Solo Leveling',
...
async function mount(value: SourceComicInfos = comic()): Promise<VueWrapper> {
...
describe('sourcesComicGeneralInfos', () => {
  ...
  it('truncates until show more is clicked on small screens', async () => {
    const wrapper = await mount()
  ...
  it('starts expanded on large screens', async () => {
