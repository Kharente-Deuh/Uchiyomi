...
const comic = defineModel<AsuraScansComicInfos>({ required: true })

const { addComicInLibrary } = useAsuraScansSearch({ doSearch: false })
const { fetchChapters } = useAsuraScansChapters()
...
<template>
  ...
  >
    <div class="d-flex flex-wrap align-center justify-space-between ga-4">
      ...
      <AsuraScansComicLinkOriginalSite :to="`${props.comicOriginUrl}`" />
    </div>
