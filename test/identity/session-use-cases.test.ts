...
function admin(overrides: Partial<User.ModelProps> = {}): User.Model {
  return new User.Model({ ...adminProps, ...overrides })
}

function withHash(overrides: Partial<User.ModelProps> = {}): User.Model {
